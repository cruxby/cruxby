...
uint256 hashGenesisBlock("0x03c0035f7ef07ed21146ead97269517275f0bb8000bbfd20b39c1d0515420afa");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(520593688); // cruxby: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "cruxby Signed Message:\n";
...
{
    // cruxby: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    int64 nSubsidy = 500000000000;

    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 840000); // cruxby: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 30240000; // cruxby: 3.5 days
static const int64 nTargetSpacing = 2; // cruxby: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // cruxby: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // cruxby: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // cruxby: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x6daa83b1cb928e53a7cfa009b3320141bdf3f0d47297f62851b7d3d8f82968d7");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "https://github.com/cruxby";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 500000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("9cbae68e2d54b19d21758d37d4057bf881a59fa1f4494614171e5c1df70ff9f255e04d3233ddfc267bc414e614a4b4077cf5ce7d21481980d4d2e5bf1eac0bcec1") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1504986324;
        block.nBits    = 520593688;
        block.nNonce   = 2672984557;

        if (fTestNet)
        {
            block.nTime    = 1504986324;
            block.nNonce   = 2999034164;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x681924c8fb3f7b50cf2903c3949ab79050ff3a02b55c8214b17841d251d98de4"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // cruxby: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("cruxbyMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("cruxbyMiner : ProcessBlock, block not accepted");
    }
